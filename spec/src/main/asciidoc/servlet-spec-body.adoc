...
=== [[a384]]Compatibility with Java Servlet Specification Version
2.5
...
defined in sections <<#a698,See Lifetime of the Request Object>> and <<#a913,See Lifetime of the Response Object>> respectively. Be aware that other than the _startAsync_
...
the rules of <<#a2114,See Specification of Mappings>>, the container builds the chain of _<url-pattern>_ matched
...
page mechanism specified in <<#a1911,See Error Handling>> to an error resource matching the _<url-pattern>_ .
...
<<#a572,See File upload>>. Clarified when _multi-part/form-data_ are processed.
...
<<#a817,See Multiple Hosts and Servlet Contexts>>. Add _ServletContext.getVirtualServerName_
method.

<<#a831,See Buffering>>. And javadoc of _ServletResponse_ . +
...
<<#a1138,See Annotations and pluggability>>, <<#a1255,See Modularity of web.xml>> and <<#a386,See Processing annotations>>. Clarify the behavior of _metadata-complete_ .

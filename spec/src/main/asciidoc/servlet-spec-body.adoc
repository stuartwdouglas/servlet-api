...
{empty}<<#a358,1.1 What is a Servlet?>>

{empty}<<#a361,1.2 What is a Servlet Container?>>

{empty}<<#a368,1.3 An Example>>

{empty}<<#a375,1.4 Comparing Servlets with Other Technologies>>

{empty}<<#a382,1.5 Relationship to Java Platform, Enterprise Edition>>

{empty}<<#a384,1.6 Compatibility with Java Servlet Specification Version 2.5>>

{empty}<<#a386,1.6.1 Processing annotations>>

=== <<#a390,The Servlet Interface>>

{empty}<<#a392,2.1 Request Handling Methods>>

{empty}<<#a397,2.1.1 HTTP Specific Request Handling Methods>>

{empty}<<#a407,2.1.2 Additional Methods>>

{empty}<<#a410,2.1.3 Conditional GET Support>>

{empty}<<#a412,2.2 Number of Instances>>

{empty}<<#a416,2.2.1 Note About The Single Thread Model>>

{empty}<<#a419,2.3 Servlet Life Cycle>>

{empty}<<#a421,2.3.1 Loading and Instantiation>>

{empty}<<#a425,2.3.2 Initialization>>

{empty}<<#a427,2.3.2.1 Error Conditions on Initialization>>

{empty}<<#a430,2.3.2.2 Tool Considerations>>

{empty}<<#a432,2.3.3 Request Handling>>

{empty}<<#a436,2.3.3.1 Multithreading Issues>>

{empty}<<#a440,2.3.3.2 Exceptions During Request Handling>>

{empty}<<#a446,2.3.3.3 Asynchronous processing>>


{empty}<<#a534,2.3.3.4 Thread Safety>>


{empty}<<#a537,2.3.3.5 Upgrade Processing>>


{empty}<<#a545,2.3.4 End of Service>>


=== <<#a553,The Request>>


{empty}<<#a555,3.1 HTTP Protocol Parameters>>


{empty}<<#a565,3.1.1 When Parameters Are Available>>


{empty}<<#a572,3.2 File upload>>


{empty}<<#a585,3.3 Attributes>>


{empty}<<#a592,3.4 Headers>>


{empty}<<#a602,3.5 Request Path Elements>>


{empty}<<#a642,3.6 Path Translation Methods>>


{empty}<<#a648,3.7 Non Blocking IO>>


{empty}<<#a662,3.8 HTTP/2 Server Push>>


{empty}<<#a668,3.9 Cookies>>


{empty}<<#a670,3.10 SSL Attributes>>


{empty}<<#a687,3.11 Internationalization>>


{empty}<<#a694,3.12 Request data encoding>>


{empty}<<#a698,3.13 Lifetime of the Request Object>>


=== <<#a704,Servlet Context>>


{empty}<<#a706,4.1 Introduction to the ServletContext Interface>>


{empty}<<#a709,4.2 Scope of a ServletContext Interface>>


{empty}<<#a712,4.3 Initialization Parameters>>


{empty}<<#a717,4.4 Configuration methods>>


{empty}<<#a720,4.4.1 Programmatically adding and configuring Servlets>>


{empty}<<#a722,4.4.1.1 addServlet(String servletName, String className)>>


{empty}<<#a724,4.4.1.2 addServlet(String servletName, Servlet servlet)>>


{empty}<<#a726,4.4.1.3 addServlet(String servletName, Class <? extends Servlet> servletClass)>>


{empty}<<#a728,4.4.1.4 addJspFile(String servletName, String jspfile)>>


{empty}<<#a730,4.4.1.5 <T extends Servlet> T createServlet(Class<T> clazz)>>


{empty}<<#a732,4.4.1.6 ServletRegistration getServletRegistration(String servletName)>>


{empty}<<#a734,4.4.1.7 Map<String, ? extends ServletRegistration> getServletRegistrations()>>


{empty}<<#a736,4.4.2 Programmatically adding and configuring Filters>>


{empty}<<#a737,4.4.2.1 addFilter(String filterName, String className)>>


{empty}<<#a739,4.4.2.2 addFilter(String filterName, Filter filter)>>


{empty}<<#a741,4.4.2.3 addFilter(String filterName, Class <? extends Filter> filterClass)>>


{empty}<<#a743,4.4.2.4 <T extends Filter> T createFilter(Class<T> clazz)>>


{empty}<<#a745,4.4.2.5 FilterRegistration getFilterRegistration(String filterName)>>


{empty}<<#a747,4.4.2.6 Map<String, ? extends FilterRegistration> getFilterRegistrations()>>


{empty}<<#a749,4.4.3 Programmatically adding and configuring Listeners>>


{empty}<<#a750,4.4.3.1 void addListener(String className)>>


{empty}<<#a759,4.4.3.2 <T extends EventListener> void addListener(T t)>>


{empty}<<#a768,4.4.3.3 void addListener(Class <? extends EventListener> listenerClass)>>


{empty}<<#a777,4.4.3.4 <T extends EventListener> void createListener(Class<T> clazz)>>


{empty}<<#a786,4.4.3.5 Annotation processing requirements for programmatically added Servlets, Filters and Listeners>>


{empty}<<#a791,4.4.4 Programmatically configuring session time out>>


{empty}<<#a795,4.4.5 Programmatically configuring character encoding>>


{empty}<<#a802,4.5 Context Attributes>>


{empty}<<#a808,4.5.1 Context Attributes in a Distributed Container>>


{empty}<<#a810,4.6 Resources>>


{empty}<<#a817,4.7 Multiple Hosts and Servlet Contexts>>


{empty}<<#a821,4.8 Reloading Considerations>>


{empty}<<#a824,4.8.1 Temporary Working Directories>>


=== <<#a829,The Response>>


{empty}<<#a831,5.1 Buffering>>


{empty}<<#a848,5.2 Headers>>


{empty}<<#a866,5.3 HTTP Trailer>>


{empty}<<#a872,5.4 Non Blocking IO>>


{empty}<<#a883,5.5 Convenience Methods>>


{empty}<<#a891,5.6 Internationalization>>


{empty}<<#a905,5.7 Closure of Response Object>>


{empty}<<#a913,5.8 Lifetime of the Response Object>>


=== <<#a918,Filtering>>


{empty}<<#a922,6.1 What is a filter?>>


{empty}<<#a932,6.1.1 Examples of Filtering Components>>


{empty}<<#a943,6.2 Main Concepts>>


{empty}<<#a946,6.2.1 Filter Lifecycle>>


{empty}<<#a962,6.2.2 Wrapping Requests and Responses>>


{empty}<<#a966,6.2.3 Filter Environment>>


{empty}<<#a968,6.2.4 Configuration of Filters in a Web Application>>


{empty}<<#a1027,6.2.5 Filters and the RequestDispatcher>>


=== <<#a1069,Sessions>>


{empty}<<#a1073,7.1 Session Tracking Mechanisms>>


{empty}<<#a1075,7.1.1 Cookies>>


{empty}<<#a1080,7.1.2 SSL Sessions>>


{empty}<<#a1082,7.1.3 URL Rewriting>>


{empty}<<#a1087,7.1.4 Session Integrity>>


{empty}<<#a1089,7.2 Creating a Session>>


{empty}<<#a1098,7.3 Session Scope>>


{empty}<<#a1103,7.4 Binding Attributes into a Session>>


{empty}<<#a1109,7.5 Session Timeouts>>


{empty}<<#a1113,7.6 Last Accessed Times>>


{empty}<<#a1115,7.7 Important Session Semantics>>


{empty}<<#a1117,7.7.1 Threading Issues>>


{empty}<<#a1119,7.7.2 Distributed Environments>>


{empty}<<#a1131,7.7.3 Client Semantics>>


=== <<#a1135,Annotations and pluggability>>


{empty}<<#a1138,8.1 Annotations and pluggability>>


{empty}<<#a1196,8.1.1 @WebServlet>>


{empty}<<#a1215,8.1.2 @WebFilter>>


{empty}<<#a1227,8.1.3 @WebInitParam>>


{empty}<<#a1229,8.1.4 @WebListener>>


{empty}<<#a1247,8.1.5 @MultipartConfig>>


{empty}<<#a1249,8.1.6 Other annotations / conventions>>


{empty}<<#a1253,8.2 Pluggability>>


{empty}<<#a1255,8.2.1 Modularity of web.xml>>


{empty}<<#a1279,8.2.2 Ordering of web.xml and web-fragment.xml>>


{empty}<<#a1418,8.2.3 Assembling the descriptor from web.xml, web-fragment.xml and annotations>>


{empty}<<#a1716,8.2.4 Shared libraries / runtimes pluggability>>


{empty}<<#a1737,8.3 JSP container pluggability>>


{empty}<<#a1743,8.4 Processing annotations and fragments>>


=== <<#a1764,Dispatching Requests>>


{empty}<<#a1768,9.1 Obtaining a RequestDispatcher>>


{empty}<<#a1776,9.1.1 Query Strings in Request Dispatcher Paths>>


{empty}<<#a1782,9.2 Using a Request Dispatcher>>


{empty}<<#a1785,9.3 The Include Method>>


{empty}<<#a1790,9.3.1 Included Request Parameters>>


{empty}<<#a1801,9.4 The Forward Method>>


{empty}<<#a1807,9.4.1 Query String>>


{empty}<<#a1809,9.4.2 Forwarded Request Parameters>>


{empty}<<#a1821,9.5 Error Handling>>


{empty}<<#a1823,9.6 Obtaining an AsyncContext>>


{empty}<<#a1825,9.7 The Dispatch Method>>


{empty}<<#a1835,9.7.1 Query String>>


{empty}<<#a1837,9.7.2 Dispatched Request Parameters>>


=== <<#a1849,Web Applications>>


{empty}<<#a1851,10.1 Web Applications Within Web Servers>>


{empty}<<#a1855,10.2 Relationship to ServletContext>>


{empty}<<#a1857,10.3 Elements of a Web Application>>


{empty}<<#a1865,10.4 Deployment Hierarchies>>


{empty}<<#a1867,10.5 Directory Structure>>


{empty}<<#a1876,10.5.1 Example of Application Directory Structure>>


{empty}<<#a1888,10.6 Web Application Archive File>>


{empty}<<#a1891,10.7 Web Application Deployment Descriptor>>


{empty}<<#a1901,10.7.1 Dependencies On Extensions>>


{empty}<<#a1907,10.7.2 Web Application Class Loader>>


{empty}<<#a1909,10.8 Replacing a Web Application>>


{empty}<<#a1911,10.9 Error Handling>>


{empty}<<#a1913,10.9.1 Request Attributes>>


{empty}<<#a1936,10.9.2 Error Pages>>


{empty}<<#a1951,10.9.3 Error Filters>>


{empty}<<#a1953,10.10 Welcome Files>>


{empty}<<#a1981,10.11 Web Application Environment>>


{empty}<<#a1984,10.12 Web Application Deployment>>


{empty}<<#a1990,10.13 Inclusion of a web.xml Deployment Descriptor>>


=== <<#a1995,Application Lifecycle Events>>


{empty}<<#a1997,11.1 Introduction>>


{empty}<<#a1999,11.2 Event Listeners>>


{empty}<<#a2004,11.2.1 Event Types and Listener Interfaces>>


{empty}<<#a2058,11.2.2 An Example of Listener Use>>


{empty}<<#a2063,11.3 Listener Class Configuration>>


{empty}<<#a2064,11.3.1 Provision of Listener Classes>>


{empty}<<#a2066,11.3.2 Deployment Declarations>>


{empty}<<#a2068,11.3.3 Listener Registration>>


{empty}<<#a2070,11.3.4 Notifications At Shutdown>>


{empty}<<#a2072,11.4 Deployment Descriptor Example>>


{empty}<<#a2088,11.5 Listener Instances and Threading>>


{empty}<<#a2091,11.6 Listener Exceptions>>


{empty}<<#a2095,11.7 Distributed Containers>>


{empty}<<#a2097,11.8 Session Events>>


=== <<#a2101,Mapping Requests to Servlets>>


{empty}<<#a2104,12.1 Use of URL Paths>>


{empty}<<#a2114,12.2 Specification of Mappings>>


{empty}<<#a2123,12.2.1 Implicit Mappings>>


{empty}<<#a2126,12.2.2 Example Mapping Set>>


{empty}<<#a2160,12.3 Runtime Discovery of Mappings>>


{empty}<<#a2163,12.3.1 Runtime Discovery of Servlet Mappings>>


=== <<#a2166,Security>>


{empty}<<#a2169,13.1 Introduction>>


{empty}<<#a2176,13.2 Declarative Security>>


{empty}<<#a2180,13.3 Programmatic Security>>


{empty}<<#a2206,13.4 Programmatic Security Policy Configuration>>


{empty}<<#a2208,13.4.1 @ServletSecurity Annotation>>


{empty}<<#a2287,13.4.1.1 Examples>>


{empty}<<#a2323,13.4.1.2 Mapping @ServletSecurity to security-constraint>>


{empty}<<#a2361,13.4.1.3 Mapping @HttpConstraint and @HttpMethodConstraint to XML.>>


{empty}<<#a2395,13.4.2 setServletSecurity of ServletRegistration.Dynamic>>


{empty}<<#a2404,13.5 Roles>>


{empty}<<#a2409,13.6 Authentication>>


{empty}<<#a2415,13.6.1 HTTP Basic Authentication>>


{empty}<<#a2418,13.6.2 HTTP Digest Authentication>>


{empty}<<#a2420,13.6.3 Form Based Authentication>>


{empty}<<#a2437,13.6.3.1 Login Form Notes>>


{empty}<<#a2447,13.6.4 HTTPS Client Authentication>>


{empty}<<#a2449,13.6.5 Additional Container Authentication Mechanisms>>


{empty}<<#a2453,13.7 Server Tracking of Authentication Information>>


{empty}<<#a2459,13.8 Specifying Security Constraints>>


{empty}<<#a2472,13.8.1 Combining Constraints>>


{empty}<<#a2477,13.8.2 Example>>


{empty}<<#a2581,13.8.3 Processing Requests>>


{empty}<<#a2585,13.8.4 Uncovered HTTP Protocol Methods>>


{empty}<<#a2622,13.8.4.1 Rules for Security Constraint Configuration>>


{empty}<<#a2627,13.8.4.2 Handling Uncovered HTTP Methods>>


{empty}<<#a2635,13.9 Default Policies>>


{empty}<<#a2637,13.10 Login and Logout>>


=== <<#a2643,Deployment Descriptor>>


{empty}<<#a2648,14.1 Deployment Descriptor Elements>>


{empty}<<#a2661,14.2 Rules for Processing the Deployment Descriptor>>


{empty}<<#a2673,14.3 Deployment Descriptor>>


{empty}<<#a2676,14.4 Deployment Descriptor Diagram>>


{empty}<<#a2794,14.5 Examples>>


{empty}<<#a2796,14.5.1 A Basic Example>>


{empty}<<#a2836,14.5.2 An Example of Security>>


=== <<#a2881,Requirements related to other Specifications>>


{empty}<<#a2885,15.1 Sessions>>


{empty}<<#a2887,15.2 Web Applications>>


{empty}<<#a2888,15.2.1 Web Application Class Loader>>


{empty}<<#a2890,15.2.2 Web Application Environment>>


{empty}<<#a2905,15.2.3 JNDI Name for Web Module Context Root URL>>


{empty}<<#a2924,15.3 Security>>


{empty}<<#a2926,15.3.1 Propagation of Security Identity in EJB™ Calls>>


{empty}<<#a2933,15.3.2 Container Authorization Requirements>>


{empty}<<#a2935,15.3.3 Container Authentication Requirements>>


{empty}<<#a2937,15.4 Deployment>>


{empty}<<#a2939,15.4.1 Deployment Descriptor Elements>>


{empty}<<#a2948,15.4.2 Packaging and Deployment of JAX-WS Components>>


{empty}<<#a2965,15.4.3 Rules for Processing the Deployment Descriptor>>


{empty}<<#a2967,15.5 Annotations and Resource Injection>>


{empty}<<#a2997,15.5.1 @DeclareRoles>>


{empty}<<#a3015,15.5.2 @EJB Annotation>>


{empty}<<#a3021,15.5.3 @EJBs Annotation>>


{empty}<<#a3030,15.5.4 @Resource Annotation>>


{empty}<<#a3043,15.5.5 @PersistenceContext Annotation>>


{empty}<<#a3050,15.5.6 @PersistenceContexts Annotation>>


{empty}<<#a3052,15.5.7 @PersistenceUnit Annotation>>


{empty}<<#a3059,15.5.8 @PersistenceUnits Annotation>>


{empty}<<#a3061,15.5.9 @PostConstruct Annotation>>


{empty}<<#a3072,15.5.10 @PreDestroy Annotation>>


{empty}<<#a3083,15.5.11 @Resources Annotation>>


{empty}<<#a3096,15.5.12 @RunAs Annotation>>


{empty}<<#a3121,15.5.13 @WebServiceRef Annotation>>


{empty}<<#a3127,15.5.14 @WebServiceRefs Annotation>>


{empty}<<#a3129,15.5.15 Contexts and Dependency Injection for Java EE requirements>>


=== <<#a3133,Change Log>>


{empty}<<#a3135,A.1 Changes Since Servlet 3.1>>


{empty}<<#a3159,A.2 Changes since Servlet 3.0>>


{empty}<<#a3199,A.3 Changes since Servlet 3.0 Proposed Final Draft>>


{empty}<<#a3204,A.4 Changes since Servlet 3.0 Public Review>>


{empty}<<#a3213,A.5 Changes since Servlet 3.0 EDR>>


{empty}<<#a3217,A.6 Changes since Servlet 2.5 MR6>>


{empty}<<#a3223,A.7 Changes since Servlet 2.5 MR 5>>


{empty}<<#a3224,A.7.1 Clarify SRV 8.4 "The Forward Method">>


{empty}<<#a3229,A.7.2 Update Deployment descriptor "http-method values allowed">>


{empty}<<#a3234,A.7.3 Clarify SRV 7.7.1 "Threading Issues">>


{empty}<<#a3239,A.8 Changes Since Servlet 2.5 MR 2>>


{empty}<<#a3240,A.8.1 Updated Annotation Requirements for Java EE containers>>


{empty}<<#a3242,A.8.2 Updated Java Enterprise Edition Requirements>>


{empty}<<#a3244,A.8.3 Clarified HttpServletRequest.getRequestURL()>>


{empty}<<#a3248,A.8.4 Removal of IllegalStateException from HttpSession.getId()>>


{empty}<<#a3250,A.8.5 ServletContext.getContextPath()>>


{empty}<<#a3258,A.8.6 Requirement for web.xml in web applications>>


{empty}<<#a3261,A.9 Changes Since Servlet 2.4>>


{empty}<<#a3262,A.9.1 Session Clarification>>


{empty}<<#a3269,A.9.2 Filter All Dispatches>>


{empty}<<#a3279,A.9.3 Multiple Occurrences of Servlet Mappings>>


{empty}<<#a3291,A.9.4 Multiple Occurrences Filter Mappings>>


{empty}<<#a3320,A.9.5 Support Alternative HTTP Methods with Authorization Constraints>>


{empty}<<#a3351,A.9.6 Minimum J2SE Requirement>>


{empty}<<#a3353,A.9.7 Annotations and Resource Injection>>


{empty}<<#a3355,A.9.8 SRV.9.9 ("Error Handling") Requirement Removed>>


{empty}<<#a3362,A.9.9 HttpServletRequest.isRequestedSessionIdValid() Clarification>>


{empty}<<#a3365,A.9.10 SRV.5.5 ("Closure of Response Object") Clarification>>


{empty}<<#a3371,A.9.11 ServletRequest.setCharacterEncoding() Clarified>>


{empty}<<#a3373,A.9.12 Java Enterprise Edition Requirements>>


{empty}<<#a3375,A.9.13 Servlet 2.4 MR Change Log Updates Added>>


{empty}<<#a3377,A.9.14 Synchronized Access Session Object Clarified>>


{empty}<<#a3379,A.10 Changes Since Servlet 2.3>>
...
the annotation as described in <<#a1136,See Annotations and pluggability>> or part of the deployment descriptor of
the Web application containing the servlet, as described in
<<#a2644,See Deployment Descriptor>>, controls how
...
environment. See <<#a705,See Servlet Context>>
...
container. The examples <<#a480,See>> ,
<<#a485,See>> and
<<#a492,See>> shown below demonstrate what the
...
defined in sections <<#a699,See Lifetime of the Request Object>> and <<#a914,See Lifetime of the Response Object>> respectively. Be aware that other than the _startAsync_
...
upgrade processing (as defined in <<#a537,See Upgrade Processing>>). Otherwise, an _IllegalStateException_ must be
...
<<#a1070,See Sessions>>”), stored in a database,
...
processed output. See <<#a1765,See Dispatching Requests>>” for more information about accessing dynamic content.
...
deployment descriptor schema in <<#a2644,See Deployment Descriptor>>. The reader should use these sources as
...
defined in <<#a2102,See Mapping Requests to Servlets>>.
...
to the rules of <<#a2115,See Specification of Mappings>>.
...
the rules of <<#a2115,See Specification of Mappings>>, the container builds the chain of _<url-pattern>_ matched
...
page mechanism specified in <<#a1912,See Error Handling>> to an error resource matching the _<url-pattern>_ .
...
<<#a1744,See Processing annotations and fragments>> and <<#a2993,See Handling of metadata-complete>> for additional details on the handling of “
_metadata-complete_ ”.
...
annotations defined in <<#a2968,See Annotations and Resource Injection>> will continue to work in the context of these
new annotations.
...
<<#a2102,See Mapping Requests to Servlets>>, wraps
...
<<#a2102,See Mapping Requests to Servlets>>. Since
...
<<#a2644,See Deployment Descriptor>>”) includes
...
_AsyncContext.dispatch_ see <<#a505,See Any errors or exceptions that may occur during the execution of the dispatch methods MUST be caught and handled by the container as follows:>>
...
<<#a2115,See Specification of Mappings>>” for the
...
in <<#a1912,See Error Handling>>”. If there is no
...
in <<#a695,See Request data encoding>>.
...
<<#a2105,See Use of URL Paths>> to select the
...
or using the annotations defined in <<#a1139,See Annotations and pluggability>> or added programmatically.
...
<<#a362,See What is a Servlet Container?>> and
<<#a359,See What is a Servlet?>>. This includes
HTTP/2 server push, see <<#a663,See HTTP/2 Server Push>>.
...
_web.xml_ and the description in <<#a2788,See default-context-path Element>> and the figure,
...
<<#a1139,See Annotations and pluggability>>.
...
_web.xml_ and _web-fragment.xml_ in <<#a1418,See Assembling the descriptor from web.xml, web-fragment.xml and annotations>>.
...
<<#a791,See Programmatically configuring session time out>> and <<#a1110,See Session Timeouts>>.
...
_ServletResponse_ . See <<#a795,See Programmatically configuring character encoding>>,
<<#a695,See Request data encoding>> and
<<#a892,See Internationalization>>.

Describe mapping discovery API. See
<<#a2161,See Runtime Discovery of Mappings>>.
...
URL. See <<#a2105,See Use of URL Paths>> for
details.

Specified support for HTTP trailer. See
<<#a867,See HTTP Trailer>> for details. Add
...
<<#a385,See Compatibility with Java Servlet Specification Version 2.5>>. Remove
subsection 1.6.1 “Listener ordering”.

<<#a446,See Asynchronous processing>>. And javadoc of _AsyncContext_ .
...
Added <<#a537,See Upgrade Processing>>, and new classes _ProtocolHandler_ and
_WebConnection_ .

<<#a573,See File upload>>. Clarified when _multi-part/form-data_ are processed.

Added Asynchronous IO in
<<#a649,See Non Blocking IO>>
and <<#a914,See Lifetime of the Response Object>>.

Clarified <<#a718,See Configuration methods>> that the ServletContextListener must be declared
...
<<#a2968,See Annotations and Resource Injection>>.
...
<<#a818,See Multiple Hosts and Servlet Contexts>>. Add _ServletContext.getVirtualServerName_
method.

<<#a832,See Buffering>>. And javadoc of _ServletResponse_ . +
...
<<#a1090,See Creating a Session>>. Add change session id.

<<#a1139,See Annotations and pluggability>>, <<#a1255,See Modularity of web.xml>> and <<#a386,See Processing annotations>>. Clarify the behavior of _metadata-complete_ .
...
<<#a1802,See The Forward Method>>. Clarified the behavior of the response when the request
is put in asynchronous mode.

<<#a2018,See HTTP Session Events>>. Add a “Changes to id” events.

<<#a1936,See Error Pages>> and <<#a2677,See Deployment Descriptor Diagram>>. Add description for default error page.

<<#a2068,See Listener Registration>>. Clarify on ordering.

<<#a2115,See Specification of Mappings>>. Clarify the behavior of servlets mapped to
the same url-pattern.

<<#a2181,See Programmatic Security>>, <<#a2361,See Mapping @HttpConstraint and @HttpMethodConstraint to XML.>> and
...
<<#a2674,See Deployment Descriptor>>. Update the schema url.
...
<<#a1991,See Inclusion of a web.xml Deployment Descriptor>> was added which removes requirement
...
Clarified <<#a1099,See Session Scope>> to allow for better support of session ids being used in
...
Made the changes in
<<#a1786,See The Include Method>> by replacing the
following text:
...
as the minimum Java version. <<#a362,See What is a Servlet Container?>> was updated to reflect this requirement.
...
listeners. <<#a2968,See Annotations and Resource Injection>> describes the annotations and resource injection in further
detail.
...
The behavior in
<<#a906,See Closure of Response Object>> the
...
<<#a906,See Closure of Response Object>> was updated to allow all headers to be set by
changing:
...
<<#a2882,See Requirements related to other Specifications>> details all requirements
